...
def register_all_pascal_voc(root="datasets"):
    ...
    for name, dirname, split, keepclasses, sid in METASPLITS:
        ...
        # Box Color
        if "1" in name.split("_")[-1]:
            MetadataCatalog.get(name).thing_colors = [[106, 0, 228],[119, 11, 32],[0, 0, 192],[197, 226, 255],[0, 0, 142],[255, 77, 255],[153, 69, 1],[0, 182, 199],[0, 226, 252],[182, 182, 255],[220, 20, 60],[163, 255, 0],[0, 82, 0],[0, 80, 100],[183, 130, 88],[165, 42, 42],[0, 60, 100],[120, 166, 157],[0, 0, 230],[3, 95, 161]]
        elif "2" in name.split("_")[-1]:
            MetadataCatalog.get(name).thing_colors = [[119, 11, 32],[165, 42, 42],[0, 0, 192],[0, 60, 100],[0, 0, 142],[255, 77, 255],[153, 69, 1],[0, 182, 199],[0, 226, 252],[0, 0, 230],[220, 20, 60],[163, 255, 0],[0, 82, 0],[0, 80, 100],[183, 130, 88],[106, 0, 228],[197, 226, 255],[120, 166, 157],[182, 182, 255],[3, 95, 161]]
        elif "3" in name.split("_")[-1]:
            MetadataCatalog.get(name).thing_colors = [[106, 0, 228],[119, 11, 32],[165, 42, 42],[197, 226, 255],[0, 60, 100],[0, 0, 142],[153, 69, 1],[120, 166, 157],[0, 182, 199],[0, 226, 252],[182, 182, 255],[220, 20, 60],[163, 255, 0],[0, 80, 100],[183, 130, 88],[0, 0, 192],[255, 77, 255],[0, 0, 230],[0, 82, 0],[3, 95, 161]]
