...
base_id_map = {v: i for i, v in enumerate(ALL_CLASSES)}
novel_id_map = {}
for v in NOVEL_CLASSES:
    novel_id_map[v] = base_id_map[v]
    base_id_map.pop(v)
...
def load_coco_json(json_file, image_root, metadata, dataset_name):
    ...
    with open("coco14_1shot.json", "w") as f:
        f.write(json.dumps(dataset_dicts, ensure_ascii=False, indent=4, separators=(',', ':')))
