...
_C.KGC.SHOTS = 1
_C.KGC.CONTAINER = 4
_C.KGC.FEATURE_DIM = 128
_C.KGC.KNOWLEDGE_MATRIX = None
_C.KGC.TAU = 0.2
_C.KGC.COEF = 1.0

# Explanation Operation
_C.COUNTERFACTUAL = CN()
_C.COUNTERFACTUAL.OPERATOR = False
_C.COUNTERFACTUAL.START_ITER = 1000
_C.COUNTERFACTUAL.ERASE_THRESHOLD = 0.6
_C.COUNTERFACTUAL.VISUALIZATION = False
_C.COUNTERFACTUAL.COUNTER_NUMBER = 3
_C.COUNTERFACTUAL.ERASE_RATE = 0.05
_C.COUNTERFACTUAL.ERASE_METHOD = "random"