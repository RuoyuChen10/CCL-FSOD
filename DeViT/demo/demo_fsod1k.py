...
def draw_bounding_boxes(
    ...
    for bbox, color, label in zip(img_boxes, colors, labels):  # type: ignore[arg-type]
        color = (0, 255, 0)
        if label in ["longhorn", "chigetai", "streptocarpus"]:
            color = (255, 0, 0)
        if fill:
...
def main(
        config_file="configs/fsod-1k/shot5.yaml", 
        rpn_config_file="configs/RPN/mask_rcnn_R_50_C4_1x_ovd_FSD.yaml",
        model_path="weights/trained/fsod-1k-base-vitl/model_final.pth", 

        image_dir_root='datasets/fsod/select_dir', 
        output_dir_root='visualization/fsod_1k/org_result_new', 
        category_space="datasets/fsod/fsod_1k_5shot_novel.pth",
        device='cuda',
