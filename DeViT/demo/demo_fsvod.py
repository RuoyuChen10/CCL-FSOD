...
def main(
        config_file="configs/fsvod/base.yaml", 
        rpn_config_file="configs/RPN/mask_rcnn_R_50_C4_1x_ovd_FSD.yaml",
        model_path="weights/trained/fsvod-base-vitl/model_final.pth", 

        image_dir_root='datasets/FSVOD-500/test_dir', 
        output_dir_root='visualization/fsvod/org_result', 
        category_space="datasets/FSVOD-500/FSVOD_5shot_novel.pth",
        device='cuda',
