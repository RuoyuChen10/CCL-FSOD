...
def main(
        ...
        model_path="output/train/fsod-1k-base-vitl-ft-1000/model_final.pth", 

        image_dir='datasets/fsod/part_test_image/peccary', 
        output_dir='datasets/fsod/ours_result/peccary', 
