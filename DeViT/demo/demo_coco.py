...
def main(
        config_file="configs/few-shot/vitl_shot30.yaml", 
        rpn_config_file="configs/RPN/mask_rcnn_R_50_C4_1x_ovd_FSD.yaml",
        model_path="weights/trained/few-shot/vitl_0089999.pth", 

        image_dir_root='datasets/coco/select_dir', 
        output_dir_root='visualization/ms-coco/org_result_new', 
        category_space=None,
        device='cuda',
    ...
    label_names = MetadataCatalog.get('coco_2017_val').thing_classes
