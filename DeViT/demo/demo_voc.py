...
def main(
        config_file="configs/voc/split3/10shot.yaml", 
        rpn_config_file="configs/RPN/mask_rcnn_R_50_C4_1x_ovd_FSD.yaml",
        model_path="output/train/voc-split3-ft-10shot-vitl/model_final.pth", 

        image_dir_root='datasets/voc_split3', 
        output_dir_root='visualization/voc-split3/org_result', 
        category_space="datasets/voc_10shot.pth",
        device='cuda',
