...
def main(
        ...
        model_path="weights/trained/fsod-1k-ft-vitl-novel/model_final.pth", 

        image_dir_root='datasets/fsod/part_test_image', 
        output_dir_root='visualization/fsod_1k/ours_result', 
